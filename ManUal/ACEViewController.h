...
@property (nonatomic, unsafe_unretained) IBOutlet UISlider *lineAlphaSlider;  // opacity
...
@property (nonatomic, unsafe_unretained) IBOutlet UIBarButtonItem *alphaButton; //opacity
...
- (IBAction)toggleAlphaSlider:(id)sender;  // opacity
- (IBAction)alphaChange:(UISlider *)sender;  // opacity
